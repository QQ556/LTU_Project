    ...
    <form name="myForm" method="post" action="update.php">
      ...
      <table border="2" align="center" bordercolor="#6666FF">
        ...
        <tr bgcolor="#99FF99"> 
          ...
          <td><?php echo $row{"Store"} ?> (如果有調店，請聯絡資訊部)</td>
        </tr>
        <tr bgcolor="#99FF99"> 
        ...
        <tr bgcolor="#99FF99"> 
          <td colspan="2" align="CENTER"> 
            <input type="button" value="修改資料" onClick="check_data()" class="button" style="background: #019e97">
            <input type="reset" value="重新填寫" class="button" style="background: #ec6200">
            <input align="right" type ="button" onclick="history.back()" value="回到上一頁" class="button"></input></td></tr>
          </td>
        </tr>
